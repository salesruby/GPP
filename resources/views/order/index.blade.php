                                    ...
                                    <tr>
                                        ...
                                        <td><a class="btn btn-primary view-order"
                                               href="{{route('orders.show', $order->id)}}">View
                                                Order</a></td>
                                        <td><a class="btn btn-link" href="{{url('gpp/public/store/'.$order->attachment)}}" download>Download
                                                File</a></td>
                                ...
                                <div class="col-md-3 sale-box wow fadeInUp" data-wow-iteration="1">
                                    <div class="sale-box-inner">
                                        ...
                                        <ul class="sale-box-desc">
                                            ...
                                            <li>
                                                <strong><a class="btn btn-link" href="{{url('gpp/public/store/'.$order->attachment)}}"
                                                           download>Download
                                                        File</a></strong>
