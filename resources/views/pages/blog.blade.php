	...
	<footer>
					...
					<div class="col-md-3 col-sm-4 col-xs-12 about-us footer-col">
						...
						<div class="footer-content">
							...
							<ul class="info">
								...
								<li>
									<i class="fa fa-phone"></i>
									<span>+3 045 224 33 12 <span>+3 045 224 48 00</span></span>
								</li>
								<li>
		...
		<div class="footer-bottom">
			<div class="container">
				<div class="row">
					<div class="col-md-12">
						<p class="copy-right">Central - Copyright © 2015 <a href="#" title="Cmsmart - Magento theme">Cmsmart.net</a>. All Rights Reserved</p>
