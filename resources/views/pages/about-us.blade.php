...
{{--                    <img src="{{asset('template/images/abouts/about01.png')}}">--}}
...
{{--                        <source src="https://drive.google.com/file/d/1Y2tOg53eHnujWSi_SoYGWgUIR4NUJmr_/view?usp=sharing" type="video/ogg">--}}
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <div class="top"><h2><span>Welcome at our Agency</span></h2>
                        <p>We are a world class, one stop Print shop with the latest and most sophisticated printing
...
{{--                        <div>--}}
{{--                            <img src="{{asset('template/images/abouts/about01.png')}}">--}}
{{--                            <h3>Yemisi Kudehinbu</h3>--}}
{{--                            <h4>Chairman</h4>--}}
{{--                            <p>--}}
{{--                                A dynamic, veteran entrepreneur whose vision in the--}}
{{--                                organizations she manages is to develop a ‘world class’ team that will provide ‘world--}}
...
{{--                    <div class="col-md-4 col-sm-4 col-xs-12">--}}
{{--                        <div>--}}
{{--                            <img src="{{asset('template/images/abouts/about02.png')}}">--}}
{{--                            <h3>Ambrose Isesele</h3>--}}
{{--                            <h4>Director</h4>--}}
{{--                            <p>--}}
...
{{--                    <div class="col-md-4 col-sm-4 col-xs-12">--}}
{{--                        <div>--}}
{{--                            <img src="{{asset('template/images/abouts/about03.png')}}">--}}
{{--                            <h3>Imoagene Folasade</h3>--}}
{{--                            <h4>Managing Director</h4>--}}
{{--                            <p>--}}
{{--                                An astute entrepreneur, a prolific business leader and visionary strategist with apt experience in--}}
